...
using HRMiniApp.Blazor.Server.Services;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddHttpClient<EmployeeApiService>();
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<HRMiniAppBlazorApplication>();
            ...
            builder.Modules
                ...
                .Add<HRMiniApp.Module.HRMiniAppModule>()
                .Add<HRMiniAppBlazorModule>();
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "HRMiniApp API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the HRMiniApp.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
        });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "HRMiniApp WebApi v1");
            });
        }
        else {
